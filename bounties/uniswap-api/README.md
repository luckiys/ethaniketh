...
Mudra strategy recommendations now include **live Uniswap swap quotes**. When the Strategist agent recommends "reduce ETH exposure", the system fetches the exact swap route, price impact, and minimum output amount from Uniswap's routing API — giving users real data before signing any approval.
