# Mudra — ETHDenver 2026 Bounty Map

> **Single narrative:** Mudra is an AI-native DeFi risk operating system where autonomous agents
...
### What we built
- Each Mudra agent (Watcher, Strategist, Executor) has an on-chain iNFT identity
