      ...
      <div className="w-full max-w-lg rounded-lg border border-zinc-800 bg-zinc-950 p-6 shadow-xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div>
            ...
            <p className="mt-0.5 text-zinc-400 leading-relaxed">{plan.worstCaseAnalysis}</p>
          </div>

          {/* Reasoning */}
          <div>
            <span className="text-xs font-medium text-zinc-500 uppercase tracking-wider">Reasoning</span>
            <p className="mt-0.5 text-zinc-400 leading-relaxed text-xs font-mono">{plan.reasoning}</p>
          </div>
